...
exports.franchise_list_productby_category = (req,res,next)=>{
    // console.log("categoryID==============",req.params.categoryID);
    Products.find({category_ID : req.params.categoryID, "status": "Publish"})
    .exec()
    .then(data=>{
...
exports.franchise_list_productby_section = (req,res,next)=>{
    Products.find({section_ID : req.params.sectionID, "status": "Publish"})
    .exec()
    .then(data=>{
        main();
...
// function franchiseProductStock(itemCode,franchiseId) {
//     return new Promise(function(resolve,reject){  
//     franchisegoods.find({"itemCode" : itemCode,"franchise_id" : franchiseId})
//     .exec()
//     .then(data=>{
//         main();
//          async function main(){
