...
exports.insertPerson = (req,res,next)=>{
        ...
        const person = new PersonMaster({
                    ...
                    preApprovedParameter        : req.body.preApprovedParameter,
                    preApprovedParameterValue   : req.body.preApprovedParameterValue,
        ...
        .then(validDrivers=>{
            ...
            if(validDrivers && validDrivers.length > 0){
                for(var i=0; i<validDrivers.length; i++){
                    if(new Date(validDrivers[i].drivingLicense.effectiveTo) <= new Date(desiredToDate)) {
                        validDrivers[i] =   {...validDrivers[i]._doc, 
