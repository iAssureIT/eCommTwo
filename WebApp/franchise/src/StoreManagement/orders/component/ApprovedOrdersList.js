...
export default class ApprovedOrdersList extends Component{
  ...
  render(){
    return(
      <div>
      <AdminOrdersList tableTitle={'Approved Order List'} data={this.state.data} allProductsArray={this.state.allProductsArray} status="Dispatch Approved" showStatusFilter="false" getOrdersFun={this.getOrders}/>
      </div>
      );
