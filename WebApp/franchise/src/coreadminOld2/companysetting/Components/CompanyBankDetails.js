    ...
    if($("#bankDetailForm").valid()){
      if (this.state.submitVal) {
        ...
        .then(function (response) {
          // handle success
          swal({
                title: "Bank details is added successfully!",
                text: "Bank details is added successfully!",
              });
        ...
        .then(function (response) {
          swal({
                title: "Bank details is updated successfully!",
                      ...
                      <form id="bankDetailForm" className="bankDetailForm">
                           <div className="form-group formht col-lg-6 col-md-6 col-sm-12 col-xs-12">
                              <div className="form-group">
                                  ...
                                  <input id="accHolderName" value={this.state.accHolderName}  data-text="accountholdername" onChange={this.handleChange.bind(this)} type="text" name="accHolderName" ref="accHolderName" className="form-control areaStaes" />
                              </div>  
                          </div>
                          <div className="form-group formht col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div className="form-group">
                          ...
                          <div className="form-group formht col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div className="form-group">
                                ...
                                <input id="accType" value={this.state.accType} onChange={this.handleChange.bind(this)} type="text" name="accType" ref="accType" className="form-control areaStaes" />
                          ...
                          <div className="form-group formht col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div className="form-group">
                                ...
                                <input id="bankName" value={this.state.bankName}  data-text="bankname" onChange={this.handleChange.bind(this)} type="text" name="bankName" className="form-control areaStaes"  />
                            </div>  
                          </div>
                          ...
                          <div className="form-group formht col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div className="form-group">
                                ...
                                <input id="accNumber" value={this.state.accNumber} data-text="accountnumber" onChange={this.handleChange.bind(this)} type="text" name="accNumber" className="form-control areaStaes" />
                            </div>  
                          </div>
                          ...
                          <div className="form-group formht col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div className="form-group">
                                ...
                                <input id="branchName" value={this.state.branchName} data-text="branchname" onChange={this.handleChange.bind(this)} type="text" name="branchName" className="form-control areaStaes" />
                            </div>  
                          </div>
                          ...
                          <div className="form-group formht col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div className="form-group">
                                ...
                                <input id="ifscCode" value={this.state.ifscCode} data-text="ifsccode" onChange={this.handleChange.bind(this)} type="text" name="ifscCode" className="form-control areaStaes" />
                            </div>  
                          </div>
