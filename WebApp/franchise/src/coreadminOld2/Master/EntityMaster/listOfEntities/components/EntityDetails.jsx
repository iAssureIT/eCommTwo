		            ...
		            <div className="row">	                   					  
					        <div id="supplierprofile" className="col-lg-12 col-md-12 col-sm-12 col-xs-12 boxshade">					   
					        	...
					        	<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 locationMainContainer">
										...
										this.state.locations.map((locationArr,index)=>{
											return(
												...
												index>1 ?
													...
													<div className="col-lg-12 textAlignCenter" onClick={this.showMore.bind(this)}>
									...
									{
										this.state.loadMoreLoc ? 
										<div className="col-lg-12 textAlignCenter" onClick={this.showLess.bind(this)}>
					        	...
					        	{ /*contact Details*/ }
					        	{
										...
										this.state.contacts.map((contact,index)=>{
											...
											{ this.state.loadMoreContacts ? 
												...
												index>1 ?
													...
													<div className="col-lg-12 textAlignCenter" onClick={this.showMoreContacts.bind(this)}>
														<label>Show more</label>
													</div>
													:
													<div className="col-lg-12 col-md-12 col-sm-12 col-sm-12 noRightPadding">
									...
									{
										this.state.loadMoreContacts ? 
										<div className="col-lg-12 textAlignCenter" onClick={this.showLessContacts.bind(this)}>
											<label>Show Less</label>
										</div> : null
									}
					        	</div>
