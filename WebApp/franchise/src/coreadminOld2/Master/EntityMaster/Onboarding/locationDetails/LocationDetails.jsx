...
class LocationDetails extends Component {
	...
	componentDidMount() {
		...
		window.scrollTo(0, 0);
		this.handleChange = this.handleChange.bind(this);
		console.log('kjgkjgkj',this.props.match.params.entityID);
	}
	openForm() {
		this.setState({
															...
															<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
																<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding">
																	<div className="col-lg-4 col-md-4 col-sm-12 col-xs-12" >
																		...
																		<select id="locationType" className="form-control col-lg-12 col-md-12 col-sm-12 col-xs-12" value={this.state.locationType} ref="locationType" name="locationType" onChange={this.handleChange}>
																	...
																	<div className="col-lg-6 col-md-6 col-sm-6 col-xs-12 " key={index}>
																		<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 boxul1">
																			...
																			<ul className="col-lg-10 col-md-10 col-sm-10 col-xs-10 palfclr addrbox">
																				...
																				<li>GSTN: {Suppliersdata.GSTIN}</li>
																				<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding">
																				{
