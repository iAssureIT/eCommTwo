																	...
																	}
																	{
																		this.props.DeletedUsersTable ?
																			<div>
																				...
																				{this.props.editId && this.props.editId === value._id ? null : <button className="btn deleteBtn btn-primary" id={value._id} onClick={this.restoreUser.bind(this)}>Restore User</button>}
																			</div>
																			: null
																	}
