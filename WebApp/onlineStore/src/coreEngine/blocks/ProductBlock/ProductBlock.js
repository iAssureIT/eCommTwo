...
class ProductBlock extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    this.setState({
      ...
      productSetting: nextProps.productSettings
    });
  }
                                ...
                                <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding">                                  
                                  {
                                    localStorage.getItem("websiteModel")=== "FranchiseModel"?
                                     <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 btnWrap NoPadding">                                                                             
                                        ...
                                        <select className="selectdropdown valid availablesize col-lg-12 col-md-12 col-sm-12 col-xs-12 NoPadding" currPro={data._id} id={data._id +"-size"} mainSize={data.size} unit={data.unit} name="size" aria-invalid="false">
