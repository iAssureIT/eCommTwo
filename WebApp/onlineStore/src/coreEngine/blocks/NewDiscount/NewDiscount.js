...
componentWillMount() {
  ...
  render() {  
        ...
        <div clasName="col-lg-12 col-md-12 col-sm-12 col-xs-12 mainDiscDiv" style={{height:"350px"}}>
         <div className="col-lg-2 col-md-2 col-sm-3 col-xs-3 image1stDiv div1background image1_div">
          <img className="img img-responsive bannerimg image1_block" style={{height:"258px"}} src={require("../../../sites/currentSite/images/Newblock1.png")} alt="banner" />
         </div>
         <div className="col-lg-4 col-md-4 col-sm-7 col-xs-7 imagediv2 ">
           ...
           <div className="col-lg-5 col-md-5 col-sm-5 col-xs-5 imge2text"style={{padding:"0px"}}>
            ...
            <h1 style={{color:"#fff"}} className="mobile_text"><b>GET 75%</b></h1>
            <a href="/deals-of-the-day"><div className="btn  new_shopnowbtn" title="Shop Now">Shop Now</div></a>
          </div>
         </div>
          <div className="col-lg-4 col-md-4 col-sm-10 col-xs-10 imagediv3">
          ...
          <div className="col-lg-7 col-md-7 col-sm-7 col-xs-7 image1stDiv">\
            <img className="img img-responsive bannerimg image1_block" style={{height:"258px"}}  src={require("../../../sites/currentSite/images/newblock3.png")} alt="banner" />
          </div>
         </div>
        </div>
    );  
