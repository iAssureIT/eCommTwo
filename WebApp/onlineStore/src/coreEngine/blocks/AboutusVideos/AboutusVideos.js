        ...
        return(
            <div className="col-lg-offset-1 col-lg-10 col-md-10 col-sm-10 col-xs-10 margin-top">
               <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <h2 className="col-lg-12 col-md-12 col-sm-12 col-xs-12 mt50 text-center"><b>AnasHandicrafts</b></h2>
                        ...
                        <div className="videocard1">
                            <div className="introvideo">      
                             {/* <video width="320" height="240" controls>
                               ...
                               <ReactPlayer url={data.link} width='425px' height='211px' controls loop  />
                            </div>          
