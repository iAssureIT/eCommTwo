...
loginPage(event){
  ...
  render() {
    ...
    return (
      <div className="headerWrapper col-lg-12 col-md-12 col-sm-12 col-xs-12" style={{padding:"0px"}}>  
        ...
        <header className="col-lg-12 col-md-12 col-sm-12 col-xs-12 headerflow hidden-xs hidden-sm"> 
          ...
          {/* <AskPincode />         */}
          <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 greenStrip "style={{padding:"0px"}}>
            <div className="col-lg-3 col-md-3 col-sm-6 col-xs-6 hidden-xs NOpadding searchBoxWrapper pull-right">
                    <div className="col-lg-12 col-md-12 searchBox">
                        <input type="text" placeholder="Search for Products and Categories" onChange={this.searchProducts.bind(this)} className="NOpadding-right zzero form-control" ref="tableSearch" id="tableSearch" name="tableSearch" />
            ...
            <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 firstDiv">
              <div className="row">           
                ...
                <div className="col-lg-9 col-md-9 col-sm-10 col-xs-10 megamenuWrapper"style={{padding:"0px"}}>
                  <nav>
                      <Megamenu />
                  </nav>
                </div>
               ...
               {/* <div className="col-lg-3 col-md-3 col-sm-6 col-xs-6 hidden-xs NOpadding searchBoxWrapper">
                ...
                <div className="col-lg-1 col-md-1 col-sm-2 col-xs-4 box-right NoPadding userdiv">  
                  <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 NoPadding">

                    <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4 dropdown faIcon cart hover-menu NoPadding " >
                      <span>  
                      {user_ID ?                      
