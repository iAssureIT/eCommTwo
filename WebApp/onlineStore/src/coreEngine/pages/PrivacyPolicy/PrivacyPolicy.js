								...
								<div className="row">
									<div className="col-lg-12 col-md-9 col-sm-9 col-xs-9 mt20 ">
										<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											...
											<span className="pull-right noStylea"><a href="#"> Home&nbsp;&nbsp;&nbsp;&nbsp; /&nbsp;&nbsp;&nbsp;&nbsp;</a><a href="#">Privacy Policy </a> </span>
											</div>
										</div>
									</div>
								</div>
								...
								<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12  mt20  ">
									<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12  ">
										...
										<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 termsAndConditionsContainer backColorWhite ">
											<label className="">Privacy Policy</label><br/><br/>
											...
											<span className="mt20 ruleHead">1. Collection of Personally Identifiable Information and other Information</span>
											<p className="mt20  paddingBottom20">
											...
											<span className="mt20 ruleHead">2. Use of Demographic / Profile Data / Your Information</span>
											<p className="mt20  paddingBottom20">
											...
											<span className="mt20 ruleHead">3. Sharing of personal information</span>
											<p className="mt20  paddingBottom20">
											...
											<span className="mt20 ruleHead">4. Links to Other Sites</span>
											<p className="mt20  paddingBottom20">
												Our Website links to other websites that may collect personally identifiable information about you. GangaExpress.com is not responsible for the privacy practices or the content of those linked websites.											</p>

											
											<span className="mt20 ruleHead">5. Security Precautions</span>
											<p className="mt20  paddingBottom20">
												Our Website has stringent security measures in place to protect the loss, misuse, and alteration of the information under our control. Whenever you change or access your account information, we offer the use of a secure server. Once your information is in our possession we adhere to strict security guidelines, protecting it against unauthorized access.												
											</p>
											<span className="mt20 ruleHead">6. Choice/Opt-Out</span>
											<p className="mt20  paddingBottom20">
											...
											If you want to remove your contact information from all GangaExpress.com lists and newsletters, please visit unsubscribe


											</p>
											<span className="mt20 ruleHead">7. Advertisements on GnagaExpress.com</span>
											<p className="mt20  paddingBottom20">
											We use third-party advertising companies to serve ads when you visit our Website. These companies may use information (not including your name, address, email address, or telephone number) about your visits to this and other websites in order to provide advertisements about goods and services of interest to you.
											</p>
											<span className="mt20 ruleHead">8. Your consent</span>
											<p className="mt20  paddingBottom20">
											...
											<span className="mt20 ruleHead">9. Grievance Officer</span>
											<p className="mt20  paddingBottom20">
											In accordance with Information Technology Act 2000 and rules made there under, the name and contact details of the Grievance Officer are provided below:


											</p>
											<span className="mt20 ruleHead">10. Questions?</span>
											<p className="mt20  paddingBottom20">
