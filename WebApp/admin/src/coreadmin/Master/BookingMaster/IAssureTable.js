...
class IAssureTable extends Component {
	constructor(props){
		...
		this.state = {
		    ...
		    "vendorData" 				: props && props.vendorData ? props.vendorData : [],
 ...
 //    } 
    ...
    showModal(event){
    	...
    	$("html,body").scrollTop(0);
    	this.setState({showDiv:true,id:id})
    }
												...
												<tr key={i} className="">
													...
													}
													{
														...
														<td className="textAlignCenter">
															{value.status === true ?
															<button type="button" className="btn btn-success" id={value.id} onClick={this.showModal.bind(this)}>Allocated To Vendor</button>
																:
															<button type="button" className="btn btn-info" id={value.id} onClick={this.showModal.bind(this)}>Allocate To Vendor</button>
															}
															{this.state.showDiv ?
															<div>
															<div id="vendorContent" className=" col-lg-12" >
																<div className="divheader col-lg-12">
															        <button type="button" className="close" onClick={this.hideModal.bind(this)}>&times;</button>
															      </div>
