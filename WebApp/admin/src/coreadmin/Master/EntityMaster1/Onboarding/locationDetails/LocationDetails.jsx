...
// 																			<a data-tip data-for='basicInfo4Tooltip' className="pull-right"> <i title="Eg. 29ABCDE1234F1Z5" className="fa fa-question-circle"></i> </a>
// 																		</label>
// 																		<input type="text" id="pincode" placeholder="411028" className="form-control uppercase col-lg-12 col-md-12 col-sm-12 col-xs-12" value={this.state.pincode} ref="pincode" name="pincode" onChange={this.handleChange} />
// 																	</div>
// 																</div>
