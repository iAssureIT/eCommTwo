      ...
      <div>
        <header className="headerWrapper">
          <div className="padd0 pageHeader">
            <div className="col-lg-3 col-md-4 col-sm-4 col-xs-4 sidebarCollapseBlock padd0">
              <div className="">
            ...
            <div className="col-lg-6 col-md-8 col-sm-8 col-xs-8 padd0 pull-right">
              <div className="">
                <div onClick={this.toggleNav.bind(this)} className="col-lg-1 col-md-1 col-sm-1 col-xs-1 pull-right nopadding textAlignCenter onHoverEffect settingsIcon hover">
                  <i className="fa fa-cogs headicon "></i>
                </div>
                <div className="col-lg-5 col-md-5 col-sm-8 col-xs-8 pull-right notificationBlock padd0">
                      ...
                      <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 user-footer showme NOpadding">
                        <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 nopadding " >
                          ...
                          <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12  headerImageContainer padd0 ">
                            ...
                            <div className="col-lg-12 col-md-6 col-sm-12 col-xs-12 pull-right  padd0 ">
