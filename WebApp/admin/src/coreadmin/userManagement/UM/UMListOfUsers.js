			...
			.then((res) => {
				...
				var tableData = tableData.map((a, i) => {
					return {
						...
						lastLogin: a.lastLogin !== "-" ? moment(a.lastLogin).format("DD-MMM-YYYY") : "-",
					}
				})
									...
									<div className="modal-bodyuser">
										<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											...
											<div className="col-lg-2 col-lg-offset-8 col-md-3 col-sm-12 col-xs-12 ">
												...
												/>
												{/*<a href="/" className="statusLabel" title="Deleted Users">Deleted Users </a>*/}
											</div>
										</div>
									</div>

{/* 
	Delete these commented lines after veirifcation
