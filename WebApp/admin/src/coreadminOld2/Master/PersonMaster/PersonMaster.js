...
class PersonMaster extends Component { 
  ...
  handleChange(event) {
    ...
    this.setState({
      ...
      console.log("workLocation",this.state.workLocation);
    });
  }
    ...
    if ($('#BasicInfo').valid()) {
      if (this.state.pathname === 'employee' ) {
        var userDetails = {
          ...
          approvingAuthorityId    : this.state.approvingAuthorityId,
        ...
        var userDetails = {
         ...
         axios.post('/api/personmaster/post', userDetails)
          .then((response) => {
            ...
            console.log("loginCredential",this.state.loginCredential)
  ...
  edit() {
    ...
    if (personID) {
      axios.get('/api/personmaster/get/one/' + personID)
        ...
        {
          console.log("response.data.address.length",response.data,response.data.address[0].countryCode);
          if (response.data.address.length > 0) {
            ...
            identityProof   : response.data.identityProof ? response.data.identityProof.identityProof : [],
                            ...
                            <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 pdcls">
                              <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 pdcls NOpadding-left driver guest employee person NOpadding-right">
                                              ...
                                              this.state.profilePhoto.map((logo, i) => {
                                                  return (
                                                      <div key={i} className="col-lg-12 col-md-2 col-sm-12 col-xs-12 nopadding CustomImageUpload">
                                                          <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding marginsBottom" id="hide">
                                                              <label className="labelform deletelogo col-lg-12 col-md-12 col-sm-12 col-xs-12" id={logo} name="profilePhoto" onClick={this.deleteDocSingle.bind(this)}>x</label>
                                                              <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 brdlogosPM" id="profilePhoto">
                                                                  <img src={logo} className="img-responsive profileImageDivlogoStyle2" />
                                                              </div>
                                                          </div>
                                                      </div>
                                                  );
                                    ...
                                    <div className=" col-lg-4 col-md-4 col-sm-12 col-xs-12 employee  person">
                                    ...
                                    </div>
                                     {
                                      this.state.getSelectedTrip === "Yes"?
                                          <div className=" col-lg-4 col-md-4 col-sm-12 col-xs-12 employee  person">
                                           <div id=""> 
                                              <label className="labelform col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding-left">Approving Authority Id<i className="astrick">*</i></label>
                                              <input type="text" className="form-control col-lg-12 col-md-12 col-sm-12 col-xs-12" value={this.state.approvingAuthorityId} ref="approvingAuthorityId" name="approvingAuthorityId" onChange={this.handleChange} />
                                            </div>
                                          </div>
                                      :
                                      null
                                      ...
                                      this.state.getSelectedTrip === "Yes"?
                                          <div className=" col-lg-4 col-md-4 col-sm-12 col-xs-12 employee  person">
                                           <div id=""> 
                                              <label className="labelform col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding-left">Pre Approved Amount<i className="astrick">*</i></label>
                                              <input type="text" className="form-control col-lg-12 col-md-12 col-sm-12 col-xs-12" value={this.state.preApprovedAmount} ref="preApprovedAmount" name="preApprovedAmount" onKeyDown={this.keyPressNumber.bind(this)}  onChange={this.handleChange} />
                                            </div>
                                          </div>
                                      :
                                      null
                                ...
                                <div className="form-margin col-lg-9 col-md-12 col-sm-12 col-xs-12  employee person NOpadding-left NOpadding-right">
                                    ...
                                    <div className=" col-lg-4 col-md-4 col-sm-12 col-xs-12 employee  person">
                                       <div id="department">
                                        ...
                                        <select id="workLocation" className="form-control col-lg-12 col-md-12 col-sm-12 col-xs-12" value={this.state.workLocation} ref="workLocation" name="workLocation" onChange={this.handleChange.bind(this)}>
                                ...
                                <div className="form-margin col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding-left NOpadding-right">
                                  ...
                                  <div className=" col-lg-4 col-md-4 col-sm-12 col-xs-12 driver  person">
                                    <div id="batchNumber">  
                                      <label className="labelform col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding-left">Batch Number <i className="astrick">*</i>
                                        <a data-tip data-for='basicInfo4Tooltip' className="pull-right"> <i title="" className="fa fa-question-circle"></i> </a>
                                      </label>
                                      <input type="text" className="form-control col-lg-12 col-md-12 col-sm-12 col-xs-12" value={this.state.batchNumber} ref="batchNumber" name="batchNumber" placeholder="" onChange={this.handleChange} />
                                    </div>
                                  </div>
                                  <div className=" col-lg-4 col-md-4 col-sm-12 col-xs-12 driver  person">
                                ...
                                <div className="form-margin col-lg-12 col-md-12 col-sm-12 col-xs-12  driver person NOpadding-left NOpadding-right">
                                  <div className=" col-lg-4 col-md-4 col-sm-12 col-xs-12 driver person">
                                    <div id="backgoundVerication">
                                      ...
                                      <input type="text"  className="form-control col-lg-12 col-md-12 col-sm-12 col-xs-12" value={this.state.vericationNumber} placeholder="" ref="vericationNumber" name="vericationNumber" onChange={this.handleChange} />
                                    </div>
                                  </div>
                                  <div className="col-lg-8 col-md-12 col-sm-12 col-xs-12  driver person">
                                    ...
                                    <div className="col-lg-1 col-md-2 col-sm-12 col-xs-12 driver NOpadding person">
                                      <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding marginsBottom" id="hide">
                                        <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 brdlogos" id="LogoImageUpOne">
                                            <div><i className="fa fa-upload"></i></div>
                                            <input multiple onChange={this.docBrowse.bind(this)} id="LogoImageUp" type="file" className="form-control col-lg-12 col-md-12 col-sm-12 col-xs-12" title="" name="vericationProof" />
                                        </div>
                                      </div>
                                    </div>

                                    {
                                      this.state.vericationProof && this.state.vericationProof.length > 0 ?
                                          this.state.vericationProof.map((logo, i) => {
                                              return (
                                                  <div key={i} className="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                                      <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding marginsBottom" id="hide">
                                                          <label className="labelform deletelogo col-lg-12 col-md-12 col-sm-12 col-xs-12" id={logo} name="vericationProof" onClick={this.deleteDoc.bind(this)}>x</label>
                                                          <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 brdlogos2" id="vericationProof">
                                                              <img src={logo} className="img-responsive logoStyle2" />
                                                          </div>
                                                      </div>
                                                  </div>
                                            ...
                                            return (
                                                <div key={i} className="col-lg-2 col-md-2 col-sm-12 col-xs-12 NOpadding-left">
                                                    <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding marginsBottom" id="hide">
                                                        ...
                                                        <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 brdlogos2" id="panProof">
                                                            <img src={logo} className="img-responsive logoStyle2" />
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            return (
                                                <div key={i} className="col-lg-2 col-md-2 col-sm-12 col-xs-12 NOpadding-left">
                                                    <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding marginsBottom" id="hide">
                                                        ...
                                                        <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 brdlogos2" id="identityProof">
                                                            <img src={logo} className="img-responsive logoStyle2" />
                                                        </div>
                                                    </div>
                                                </div>
