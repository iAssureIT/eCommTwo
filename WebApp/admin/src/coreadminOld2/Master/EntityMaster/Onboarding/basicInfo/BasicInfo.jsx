                        ...
                        <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                          <div className="col-lg-12 col-md-12 col-sm-12 supplierForm">
                                    ...
                                    </div>
                                    {
                                      this.state.companyLogo && this.state.companyLogo.length > 0 ?
                                        this.state.companyLogo.map((logo, i) => {
                                          return (
                                            <div key={i} className="col-lg-12 col-md-3 col-sm-12 col-xs-12 CustomImageUploadBI">
                            ...
                            <div className="col-lg-3 col-md-3 col-sm-12 col-xs-12 panerror" >
                                    <label className="labelform col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding-left">Tax Deduction Account Number<i className="astrick">*</i>
                              ...
                              <div className="col-lg-3 col-md-3 col-sm-12 col-xs-12" >
                                <label className="labelform col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding-left">Corporate Identification Number<i className="astrick">*</i>
