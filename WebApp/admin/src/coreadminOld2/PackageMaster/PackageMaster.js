                ...
                <div className="">
                  <div className="col-lg-12 col-md-4 col-sm-12 col-xs-12">
                    <div className="form-group valid_box col-lg-4 col-md-4 col-sm-12 col-xs-12" >
                      <label className="">Package Type <span className="astrick">*</span></label>
                    ...
                    <div className="form-group valid_box col-lg-4 col-md-4 col-sm-12 col-xs-12">
                      <div className="" id="fixCharges">
                        <label className="" >
                          Fix Charge <span className="astrick">*</span>
                        </label>
                        <input
                          onChange={this.handleChange.bind(this)}
                    ...
                    <div className="form-group valid_box col-lg-4 col-md-4 col-sm-12 col-xs-12">
                      <div className="" id="maxKm">
                        <label className="" >
                          Max Km <span className="astrick">*</span>
                        </label>
                        <input
                          onChange={this.handleChange.bind(this)}
