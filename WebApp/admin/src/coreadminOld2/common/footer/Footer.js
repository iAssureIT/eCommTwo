    ...
    return(
      <footer  className="main-footer col-lg-12 col-md-12 col-sm-12 col-xs-12  fontSize14">
        <div className="col-lg-5 col-md-5 col-sm-5 col-xs-12">
          <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 nopadding"><b><span className="">Copyright © 2020</span> <a href="/" className="footerLeftCss">Anas Handicrafts.</a></b><span className="footclr">&nbsp;&nbsp;All rights
            reserved.</span>
          </div>
        </div>
