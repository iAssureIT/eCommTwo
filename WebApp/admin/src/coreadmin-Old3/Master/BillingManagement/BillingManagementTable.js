...
class BillingManagementTable extends Component {
	constructor(props){
		super(props);
		this.state = {
    ...
    GenerateBill(event){
    	...
    	this.props.history.push('/create-invoice/'+id)
    }
												...
												<tr key={i} className="">
													...
													}
													{
														...
														<td className="col-md-12">
															<button type="button" className="btn btn-primary btn-sm col-lg-12" id={value.id} onClick={this.GenerateBill.bind(this)}>Generate Bill</button><br/>
															<button type="button" className="btn btn-warning btn-sm col-lg-12 marginTop8" onClick={this.Cancel.bind(this)}>Cancel</button>
														</td>
														:
														null
													}
...
export default withRouter(BillingManagementTable);