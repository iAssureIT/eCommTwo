...
export default class ApprovedOrdersList extends Component{
  ...
  getOrders(){
      var orderFilterData= {};
      orderFilterData.status = 'Dispatch Approved';
  ...
  render(){
    return(
      <div>
      <AdminOrdersList tableTitle={'Approved Order List'} data={this.state.data} allProductsArray={this.state.allProductsArray} showStatusFilter="false" status="Dispatch Approved" getOrdersFun={this.getOrders}/>
      </div>
      );
