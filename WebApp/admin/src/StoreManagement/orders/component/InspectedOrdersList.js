...
export default class InspectedOrdersList extends Component{
  ...
  getOrders(){
      var orderFilterData= {};
      orderFilterData.status = 'Inspection';
  ...
  render(){
    return(
      <div>
      <AdminOrdersList tableTitle={'Inspected Order List'} data={this.state.data} allProductsArray={this.state.allProductsArray} showStatusFilter="false" status="Inspection" getOrdersFun={this.getOrders}/>
      </div>
      );
