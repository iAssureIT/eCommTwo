...
export default class AllFeatureProducts extends React.Component {
  ...
  addtocart(productid) {
    // console.log("productid addCart =========>", this.state.packsizes);
    const formValues = {
                ...
                <View style={styles.proddets}>
                  {this.state.featuredProducts ?
                     this.state.featuredProducts.length > 0  ?
                      this.state.featuredProducts.map((item, i) => {
                            ...
                            <View style={styles.flx5}>
                              <View style={styles.flx1}>
                                ...
                                <TouchableOpacity style={[styles.flx1, styles.wishlisthrt]} onPress={() => this.addtowishlist(item._id)} >
                                  <Icon size={20} name='heart-o' type='font-awesome' color='#80c21c'  />
                                  {/* <Icon size={20} name='heart' type='font-awesome' color='#80c21c'  /> */}
                                </TouchableOpacity>
                                {
